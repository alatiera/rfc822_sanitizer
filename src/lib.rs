...
mod tests {
    ...
    fn foo() {
        ...
        let correct_dates = vec![
            "6 Jul 2017 15:30:00 PDT",
            "10 Jul 2017 16:00:00 PDT",
            "17 Jul 2017 17:00:00 PDT",
            "24 Jul 2017 16:00:00 PDT",
            "31 Jul 2017 16:00:00 PDT",
            "30 Aug 2017 01:30:00 PDT",
        ...
        for (bad, good) in bad_dates.iter().zip(correct_dates.iter()){

            assert_eq!(from_rfc822_to_rfc2822(bad) ,DateTime::parse_from_rfc2822(good))
        }
